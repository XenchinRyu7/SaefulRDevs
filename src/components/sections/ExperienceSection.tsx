...
const experiences = [
	{
		...
		description:
			'Led development of key features for a SaaS platform, mentored junior developers, and improved application performance by 20%. Technologies: React, Node.js, AWS.',
		tasks: [
	...
	},
	{
		...
		description:
			'Contributed to various client projects, focusing on front-end development and API integration. Worked with Vue.js, Express, and MongoDB.',
		tasks: [
...
export const ExperienceSection = () => {
	return (
		<SectionWrapper id="experience" title="Work Experience" icon={Briefcase}>
			<div className="jos relative space-y-12 before:absolute before:inset-0 before:ml-5 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-primary/50 before:to-transparent md:before:mx-auto md:before:ml-0" data-jos_animation="fade-up" data-jos_duration="0.7">
				{experiences.map((exp, index) => (
					<div key={index} className="jos" data-jos_animation={index % 2 === 0 ? 'slide-right' : 'slide-left'} data-jos_duration="0.8" data-jos_delay={`${index * 0.2}`}> {/* Alternating direction & stagger */}
						<ExperienceItem experience={exp} index={index} isLeft={index % 2 === 0} />
					</div>
				))}
			</div>
		</SectionWrapper>
